...
xylemleaf_mod <- lmer(xylem_area_mm2 ~ lamina_area_cm2  * niche2  + (1|species),
                    data=alldata4)

#model diagnostics
qqPlot(residuals(xylemleaf_mod)) 
plot(xylemleaf_mod)

#model summary
Anova(xylemleaf_mod, type="3") #no interactions
r.squaredGLMM(xylemleaf_mod)
# R2m       R2c
# [1,] 0.4404968 0.8574309
