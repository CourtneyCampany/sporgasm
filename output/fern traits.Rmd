...
This document contains summary statistics for the 2017 La Selva field work. Below are visualizations for many of the fern functional traits we measured including SLA, stomatal density, cholorophyll content, lamina length and lamina area.
...
boxplot(sla ~ niche, data=sla_mass_clean, outline=FALSE,xaxt='n',ylim=c(0,210),
        ylab=expression(Specific~leaf~area~~(g/cm^2)),outline=FALSE)
axis(1, niche_lab, at=1:4, cex=1.1)
text(x=c(1,2,3,4),y=200, labels=niche_lab2)
