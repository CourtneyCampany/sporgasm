...
#pv parameters
pv <- read.csv("plots/pv_curves2.csv")
...
##raw data points
pv_data <- read.csv("plots/pv_curves_full.csv")
...
#       lwd=4, lty=2, col=trtcols[3])
# text(65, .015, "D", cex=1.5)
# 
# par(fig=c(.7, .95, 0.25,0.45), mar=c(0,3.5,0,0),new=T, cex=1, las=1,
#     cex.axis=.9, cex.lab=.9, tcl=-.25,mgp=c(2,.5,0))
