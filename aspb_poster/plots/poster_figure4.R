...
jpeg(filename = "aspb_poster/plots/figure4_poster.jpeg",
      width = 10, height = 6, units = "in", res= 400)

par(mar=c(6,4,1,1), mfrow=c(1,2),mgp=c(2,.75,0),cex.lab=1.25,cex.axis=1.25)
...
mtext("Figure 4. (A) Raw results from pressure volume curves from 33 tropical fern species.", 1, line=4, adj=0)
mtext("               (B) Box plots of turgor loss point across life forms",
      1, line=5, adj=0)
#tlp
