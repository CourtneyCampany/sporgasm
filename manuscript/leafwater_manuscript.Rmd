...
\
^4^ Natural Science Division at Pepperdine University, Malibu, CA, USA
...
```{r figure1,  echo=FALSE, fig.width = 10, fig.height = 6, warning=FALSE, message=FALSE}
...
```{r figureS1,  echo=FALSE,fig.width = 6, fig.height = 6, warning=FALSE, message=FALSE}
...
```{r figureS2,  echo=FALSE,fig.width = 6, fig.height = 6, warning=FALSE, message=FALSE}
