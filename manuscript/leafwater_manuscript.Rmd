...
```
Figure 5. Epiphytic ferns species are not more drought tolerant. Osmotic adjustments, not shifts in cell wall flexibility explain differences in TLP. I am not sure what capacitance at TLP means.
...
```
Figure 6. Ancestral state reconstructions for biomechanical and hhydraulic traits
