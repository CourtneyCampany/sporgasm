...
\
Tests of allometric relationships between log-transformed morphological traits were implemented using standardized major axis regression in the 'smatr' package in R [@warton_smatr_2012]. 

\ 
All tests of statistical significance were conducted at an $\alpha$ level of 0.05. All analyses were performed with R 3.5.1 [@team_r_2013].
...
![](asr_stipe.jpeg)
\
Figure 6. Ancestral state reconstruction for stipe length mapped onto the phylogeny of the selected ferns examined in this study. A bootstrap value is associated with each node.

\

![](asr_stomata.jpeg)
\
Figure 7. Ancestral state reconstruction for stomatal density mapped onto the phylogeny of the selected ferns examined in this study. A bootstrap value is associated with each node.
