...
=======
Tropical epiphytic ferns routinely face environmental conditions that are distinct from the forest floor. Despite large annual precipitation, epiphytic ferns without a root-soil connection have likely faced strong selection pressures from a transient water supply. In conjuction with limited access to elemental nutrients (i.e. N and P), epiphytic ferns must adapt structural traits to optimize both nutient retention and efficient hydraulic transport. The evolution of these traits would have been essential to maintain a postive carbon balance as ferns radiated into the canopy niche. Here, evidence of the selection of both reduced xylem area and stipe length for water transport is evident in the diversification of epiphtic and hemi-epiphytic ferns in our studied species. Additionally, the selection of thick lamina (&uparrow; LMA) is readily apparent in the diversification of epiphytic ferns. Evaluating why these strucutral traits evolved requires unpacking their role in the biomechanics of form of epiphytic ferns.
...
>>>>>>> 157828fe7b30226b8c3f0687356da4724090019e

/

## Avoidance versuse dessication in tropical ferns

turgor loss point not different
osmotic potential less negative in epiphytes  
tissue capacitance at turgor loss point lower in epiphytes
 tissue capacitance at full turgor declines as bulk modulus of elasticity increases simiarlirly.
 
 driven by osmotic adjustments via solute accumulations rather than shifts in cell wall flexibility
 
 Osmotic adjustments appeared to occur in epiphytic ferns ($\Psi$~o~)
 
 ΨTLP has been found to be an indicator of drought tolerance across a wide range of plants and ecosystems (Bartlett et al., 2012).
 
 Osmotic regulation may be an important adaptation for angiosperms epiphytes living in drier sites to enable continued water uptake from canopy soils [gotsch]
...
A growing body of evidence now suggests that epiphyitc angiosperms do this .... (gotsch) use of nocturnal due to mainatin water balance [@Chavez-Sahagun], osmotic adjustments and alteration to sap flow [@gotsch], thick cutitcles and laves,  dense veins and stomata and water storage in pseudodbulbs of orchids [@yang; @zhang]

Lepisorus thunbergianus (epiphytic) had low stomatal density and showed high water-use efficiency (WUE) retaining photosynthetic activity with low relative frond water content under drought stress, which suggested their high adaptation to drought. [@nishida]
