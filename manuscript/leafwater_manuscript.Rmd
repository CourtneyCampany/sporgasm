...
\
Courtney E. Campany^1,2^, Jarmila Pitterman^3^, Alex Baer^3^, Helen Holmlund^3^, Eric Schuettpelz^4^, Klaus Mehltreter^5^ and James E. Watkins Jr. ^1^
...
\
^5^ Red de Ecología Funcional, Instituto de Ecología A.C. Veracruz, México
...
This study sought to provide new insight on the mechanisms by which ferns, with potentially limited plasticity in ecophysiological function, successfully diversified  into epiphytic habitats. Our results suggest that adaptations of functional traits related to avoidance of water stress (e.g. &uarr; LMA * &darr; stomatl density), instead of tolerance, allowed the radiation of ferns into more variable canopy habitats. Although the role of hemi-epiphytic species in this radiation remains uncertain, we provide additional evidence to help understand the evolutionary origins of this life form. Epiphytic ferns have been previously been shown to be consistently smaller than terrestrial ferns [@testo_are_2018; @nitta_life_2020]. Here, we examine a suite of traits and biomechanical relationships related to leaf water relations that likely underpin this reduction in size.
