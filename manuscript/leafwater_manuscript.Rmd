...
* Opportunistic diversification has allowed ferns to radiate into epiphytic niches created by angiosperm dominated landscapes. Our understanding of how canalized ecophysiological function allowed radiation into the variable canopy habitat and the potential transitionary role of the hemi-epiphytic life form remains unclear.
...
Epiphytic and hemi-epiphytic species had 51% lower stomatal density compared to terrestrial species (Figure 4A, *P* < 0.001). Stomata of epiphytic species were 10.4% larger in epiphytes compared to terrestrial species, with hemi-epiphytes intermediates between both life forms (Figure 4B, *P* = 0.037). Differences in stomatal size were driven by 16.0% greater guard cell width in epiphytes and hemi-epiphytes ($\overline{x}$ = 13.3 um) compared to terrestrial species ($\overline{x}$ = 11.2 um, *P* = 0.002). Guard cell length was statistically similar across life forms ($\overline{x}$ = 47.7 um). 

<!-- Increases in stomatal density were negatively correlated with stomatal size across all life forms (*P* < 0.001). Pair-wise differences across life forms were detected for the slopes (*P* < 0.001) and elevations (*P* = 0.007) of the negative relationship between stomatal density and stomatal size (Figure 4B). Phylogenetic independent contrasts support the negative relationship between stomatal density and stomatal size for measured species (*P* = 0.006, R^2^ = 0.17). -->
...
<!-- Significant linear relationships for each life from are shown with dashed lines representing model fits and grey shaded areas as 95 % confidence intervals for the mean. The conditional and marginal R^2^ for the overall linear relationship is reported. -->
