...
* Paragraph: Consequences of radiation of plants into canopy, Evolution of traits
  ...
  + Regardless, epiphytic ferns span a vast arraw of microhabitats that will undergo a suite of environmental stresses (high light, high ph, limited water) that should....
...
\
Bivariate relationships among continuous traits were analysed with phylogenetically independent contrasts (PIC) in the 'ape' package in R [@paradis_ape_2019].
...
\ 
All tests of statistical significance were conducted at an $\alpha$ level of 0.05. All analyses were performed with R 3.5.1 [@r_core_team_r:_2018].
...
## Phylogentic traits relationships:
...
![](asr_stipe.jpeg)
\
Figure 6. Ancestral state reconstructions for stipe length

\

![](asr_stomata.jpeg)
\
Figure 7. Ancestral state reconstructions for stomatal density
