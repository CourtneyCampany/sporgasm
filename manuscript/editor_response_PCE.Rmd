...
\
*Response*: SHOULD THIS BE 'DROUGHT" or "STRESS"
...
\
*Response*: Yes, we did think to test for this relationship. The overall relationship was not significant. The lack of a realtionship mostly due to a large amount of variation among the terrestrial and epiphytic species. 
...
\
*Response*: The reviewer correctly points out that this paragraph repeats specific results from leaf water relations. These sentences broadly review the findings of leaf pressure volume parameters. We feel this is important because the parameters of pressure volume curves are not broadly known, such as a trait like LMA. The context of this paragraph is also to remind the reader that many of these parameters were similar between life forms (not expected) and that drought tolerance traits were not detected in epiphytes as hypothesized. Both of these points provide some interpretation. 
