...
jpeg(filename = "aspb_poster/plots/asr_stipe.jpeg",
...
add.simmap.legend(leg = niche_lab_goodorder,outline=FALSE,
                  ...
                  x=.07,y=-.75,vertical=TRUE,fsize=0.6)
text(x=.075, y=-5, "Figure 6. Ancestral state reconstruction for stipe length mapped onto the phylogeny of the ferns in this study.", cex=.7)
