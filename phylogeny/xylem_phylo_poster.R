...
jpeg(filename = "aspb_poster/plots//asr_xa.jpeg",
...
text(x=.075, y=-5, "Figure 6. Ancestral state reconstruction for xylem area mapped onto the phylogeny of the ferns in this study.", cex=.7)
